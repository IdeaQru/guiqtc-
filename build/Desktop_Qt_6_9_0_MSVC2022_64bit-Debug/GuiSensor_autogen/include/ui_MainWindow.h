...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabMaps = new QWidget();
        tabMaps->setObjectName("tabMaps");
        verticalLayout_10 = new QVBoxLayout(tabMaps);
        verticalLayout_10->setObjectName("verticalLayout_10");
        mainTabWidget->addTab(tabMaps, QString());
...
"          }", nullptr));
        ...
        mainTabWidget->setTabText(mainTabWidget->indexOf(tabMaps), QCoreApplication::translate("MainWindow", "Maps", nullptr));
    } // retranslateUi
