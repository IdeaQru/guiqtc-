...
QT_MOC_LITERAL(3, 28, 3), // "afr"
QT_MOC_LITERAL(4, 32, 3), // "rpm"
QT_MOC_LITERAL(5, 36, 4), // "temp"
QT_MOC_LITERAL(6, 41, 3), // "tps"
QT_MOC_LITERAL(7, 45, 3), // "map"
QT_MOC_LITERAL(8, 49, 9), // "timestamp"
QT_MOC_LITERAL(9, 59, 23), // "connectionStatusChanged"
QT_MOC_LITERAL(10, 83, 9), // "connected"
QT_MOC_LITERAL(11, 93, 13), // "errorOccurred"
QT_MOC_LITERAL(12, 107, 12), // "errorMessage"
QT_MOC_LITERAL(13, 120, 8), // "readData"
QT_MOC_LITERAL(14, 129, 11), // "handleError"
QT_MOC_LITERAL(15, 141, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(16, 170, 5) // "error"

    },
    "SerialHandler\0dataReceived\0\0afr\0rpm\0"
    "temp\0tps\0map\0timestamp\0connectionStatusChanged\0"
    "connected\0errorOccurred\0errorMessage\0"
...
void SerialHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataReceived((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4])),(*reinterpret_cast< double(*)>(_a[5])),(*reinterpret_cast< double(*)>(_a[6]))); break;
        ...
        {
            using _t = void (SerialHandler::*)(double , double , double , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialHandler::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialHandler::connectionStatusChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialHandler::errorOccurred)) {
                *result = 2;
                return;
            }
        }
